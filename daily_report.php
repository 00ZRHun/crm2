			...
			<form id="form1" name="form1" method="post" action="collection.php">
				<table align="center">
							...
							<table width="150%" cellspacing="1" cellpadding="1" border="1">
								...
								<tbody>
									<tr>
										...
										<td>
											<div align="right"><?php
																...
																echo $previous_balance; ?></div>
										</td>
									</tr>
									<tr>
										<td colspan="5"><strong>Total Collection</strong></td>
										<td>
											<div align="right"><?php echo $total_collection; ?></div>
										</td>
									</tr>
									<tr>
										<td colspan="5"><strong>Total Interest</strong></td>
										<td>
											<div align="right"><?php echo $total_interest; ?></div>
										</td>
									</tr>
									<tr>
										<td colspan="5"><strong>Kongsi In</strong></td>
										<td>
											<div align="right"><?php echo $inbalance; ?></div>
										</td>
									</tr>
									<tr>
										<td colspan="5"></td>
									...
									<tr>
										...
										<td>
											<div align="right"><?php echo $advance; ?></div>
										</td>
									</tr>
									<tr>
										<td colspan="5"><strong>&nbsp;Kongsi Out</strong></td>
										<td>
											<div align="right"><?php echo $outbalance; ?></div>
										</td>
									</tr>
									<tr>
									<tr>
										...
										<td>
											<div align="right"><?php echo $misc; ?></div>
										</td>
									</tr>
									<tr>
										<td colspan="5"><strong>&nbsp;Repair</strong></td>
										<td>
											<div align="right"><?php echo $repair; ?></div>
										</td>
									</tr>
									<td colspan="4"></td>
									<td>
									...
									<td>
										<div align="right"><?php echo $advance + $outbalance + $misc + $repair; ?></div>
									</td>
					</tr>
					<tr>
						<td colspan="6">&nbsp;</td>
					...
					<tr>
						...
						<td>
							<div align="right"><?php echo  $loanout; ?></div>
						</td>
					</tr>
					<tr>
						<td colspan="4">&nbsp;</td>
					...
					<tr>
						...
						<td>
							<div class="SubMenuCaption" align="right"><?php //echo -$previous_balance +($total_collection + $inbalance)- ($advance+$outbalance+$misc+$repair) - $loanout;
																		echo $total_collection + $total_interest + $inbalance - ($advance + $outbalance + $misc + $repair) - $loanout; ?></div>
						</td>
